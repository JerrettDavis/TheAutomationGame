...
public sealed class DishStationGame : Game
{
    ...
    private readonly string restaurantAssetStatus = RestaurantAlphaAssetAudit.Validate(RestaurantAlphaAssetAudit.AcceptedSurfaces).Count == 0
        ? "alpha"
        : "invalid";
